...
public class ControllerManager(WebServer webServer, Analyzer analyzer, ObjectController objectController, ILogger logger) : Manager
{
    ...
    private void RegisterController(Type type, ControllerAttribute attribute)
    {
        ...
        var method = typeof(ControllerManager).GetMethod(nameof(RegisterController),
            ...
            binder: null,
            types: [typeof(ControllerAttribute)],
            modifiers: null);
